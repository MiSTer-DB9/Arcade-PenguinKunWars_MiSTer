...
UPSTREAM_REPO="https://github.com/MiSTer-devel/Arcade-PenguinKunWars_MiSTer.git"
CORE_NAME=(Arcade-PenguinKunWars)
...
UPSTREAM_CORE_NAME=(Arcade-PenguinKunWars)
MAIN_BRANCH="main"
UPSTREAM_BRANCH="main"
COMPILATION_INPUT=(Arcade-PenguinKunWars.qpf)
COMPILATION_OUTPUT=(output_files/Arcade-PenguinKunWars.rbf)
